...
static const int64 MIN_TX_FEE = 50 * COIN;
static const int64 MIN_RELAY_TX_FEE = 50 * COIN;
...
int64 GetProofOfStakeReward(int64 nCoinAge, int64 nFees, unsigned int nBits, unsigned int nTime, int nHeight);
...
public:
    ...
    bool SignBlock(const CKeyStore& keystore, int64 nFees);
